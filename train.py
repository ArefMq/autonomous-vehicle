...
def main():
    ...
    for step in range(cfg.TRAINING_STEPS):
        ...
        print(
            'step {:d} \t total loss = {:.3f}, sub4 = {:.3f}, sub24 = {:.3f}, sub124 = {:.3f}, val_loss: {:.3f} ({:.3f} sec/step)'.format(step, loss_value, loss1, loss2, loss3, val_loss_value, duration))
